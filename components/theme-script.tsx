 ...
 */
const script = `(function(){var r=document.documentElement;r.dataset.js="1";try{var t=localStorage.getItem("driplink-theme");r.dataset.theme=t==="light"?"light":"dark"}catch(e){}})()`;
